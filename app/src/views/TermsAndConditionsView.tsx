...
export const TermsAndConditionsView = (): JSX.Element => {
  const { t } = useTranslation()
  return (
    <div className='flex justify-center py-20 px-12'>
      <div className='max-w-4xl'>
        <h1 className='text-xl'>{t('Terms and Conditions')}</h1>
        <p>
        ...
        <h2 className='text-lg mt-4'>Punkt 1</h2>
        <p>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris
          nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non
          proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
        ...
        <h2 className='text-lg mt-4'>Punkt 2</h2>
        <p>
